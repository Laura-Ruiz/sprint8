    ...
    return (
        <div id="container-home">
            ...
            <p id="description">
                ...
                time ago in a galaxy far, far away", in which humans and many species of
                ...
                technology. The planets range from wealthy, planet-wide cities
                ...
                alien life. The franchise also makes use of other astronomical
                objects such as asteroid fields and nebulae. Spacecraft range
                ...
                ... binds the galaxy together". The field is depicted as a kind
                of pantheistic god. Through training and meditation, those whom "the
                Force is strong with" exhibit various superpowers (such as telekinesis,
                precognition, telepathy, and manipulation of physical energy). It is
                believed nothing is impossible for the Force. The mentioned powers
                are wielded by two major knightly orders at conflict with each other:
                the Jedi, peacekeepers of the Galactic Republic who act on the light
                side of the Force through non-attachment and arbitration, and the Sith,
                who use the dark side by manipulating fear and aggression. While Jedi
                Knights can be numerous, the Dark Lords of the Sith are
                intended to be limited to two: a master and their apprentice.
                Another notable fictional element of Star Wars is hyperspace, an
                alternate dimension that allows faster-than-light travel.
                <br></br>
                <br></br>
                Force-wielders are very limited in numbers in comparison to the population. The Jedi
                ...
                politics, all this weaponry is made use of in various military conflicts
